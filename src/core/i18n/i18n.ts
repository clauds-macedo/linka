...
const translations = {
  [ELocale.PT_BR]: {
    ...
    'home.authTitle': 'Acesse sua conta',
    'home.authSubtitle': 'Crie uma conta para criar e participar de salas',
    'home.signIn': 'Entrar',
    'home.signUp': 'Criar conta',
    'home.loadError': 'Erro ao carregar as salas',
    'createRoom.title': 'Criar Sala',
    'createRoom.subtitle': 'Defina um vídeo do YouTube para sincronizar',
    'createRoom.selectSource': 'Escolha uma fonte de vídeo',
  ...
  [ELocale.EN_US]: {
    ...
    'home.authTitle': 'Access your account',
    'home.authSubtitle': 'Create an account to create and join rooms',
    'home.signIn': 'Sign in',
    'home.signUp': 'Sign up',
    'home.loadError': 'Failed to load rooms',
    'createRoom.title': 'Create Room',
    'createRoom.subtitle': 'Set a YouTube video to sync',
    'createRoom.selectSource': 'Choose a video source',
